...
function connectElements(svg, path, startElem, endElem) {
    ...
    var startX = startCoord.left + 0.5*startRect.outerWidth() - svgLeft;    // x = left offset + 0.5*width - svg's left offset
    var startY = startCoord.top  + startRect.outerHeight() - svgTop;        // y = top offset + height - svg's top offset
        // calculate path's end (x,y) coords
    var endX = endCoord.left + 0.5*endRect.outerWidth() - svgLeft;
