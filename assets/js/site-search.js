document.addEventListener("DOMContentLoaded", function() {
    ...
    const renderStats = (renderOptions, isFirstRender) => {
        ...
        if(filterLang == 'en') {
            ...
            `<p class="text-white mb-0">${count} found in ${processingTimeMS}ms</p>`
        } else if(filterLang == '') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} found in ${processingTimeMS}ms</p>`
        } else if(filterLang == 'es') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} encontrado en ${processingTimeMS}ms</p>`
        } else if(filterLang == 'fr') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} trouvé dans ${processingTimeMS}ms</p>`
        } else if(filterLang == 'de') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} gefunden in ${processingTimeMS}ms</p>`
        } else if(filterLang == 'it') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} trovato in ${processingTimeMS}ms</p>`
        } else if(filterLang == 'pl') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} znaleziony w ${processingTimeMS}ms</p>`
        } else if(filterLang == 'tr') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} içinde bulundu ${processingTimeMS}ms</p>`
        } else if(filterLang == 'zh-hans') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} 在 ${processingTimeMS}ms</p>`
        } else if(filterLang == 'ar') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} موجودة في ${processingTimeMS}ms</p>`
        } else if(filterLang == 'nb') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} funnet i ${processingTimeMS}ms</p>`
        } else if(filterLang == 'pt-br') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} encontrado em ${processingTimeMS}ms</p>`
        } else if(filterLang == 'pt') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} encontrado em ${processingTimeMS}ms</p>`
        } else if(filterLang == 'cz') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} nalezené v ${processingTimeMS}ms</p>`
        } else if(filterLang == 'nl') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} gevonden in ${processingTimeMS}ms</p>`
        } else if(filterLang == 'ja') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} で見つかった。 ${processingTimeMS}ms</p>`
        } else if(filterLang == 'sv') {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} finns i ${processingTimeMS}ms</p>`
        } else {
            widgetParams.container.innerHTML =
            `<p class="text-white mb-0">${count} found in ${processingTimeMS}ms</p>`
        }
    ...
    if (filterLang == "en") {
        typeMapping = {
            ...
            'statementsandcompliance': 'Statements and Compliance',
        ...
        vidMapping = {
            ...
            'pillars': 'Content Index',
            'continents': 'Continents',
            'asia': 'Locations Index',
            'europe': 'Locations Index',
            'northamerica': 'Locations Index',
            'southamerica': 'Locations Index',
            'africa': 'Locations Index',
            'australasia': 'Locations Index',
            'middleeast': 'Locations Index',
            'industry': 'Industry',
        ...
        vidMapping = {
            'resourcescontenttypes': 'Índice de contenidos',
            'producttypes': 'Tipos de productos',
            'pillars': 'Índice de contenidos',
            'continents': 'Continentes',
            'asia': 'Índice de ubicaciones',
            'europe': 'Índice de ubicaciones',
            'northamerica': 'Índice de ubicaciones',
            'southamerica': 'Índice de ubicaciones',
            'africa': 'Índice de ubicaciones',
            'australasia': 'Índice de ubicaciones',
            'middleeast': 'Índice de ubicaciones',
            'industry': 'Industria',
            'glandpacking': 'Categoría de empaquetadura',
            'sealsupportsystems': 'Categoría de sistemas de soporte de sellado',
            'bearingprotectioncategories': 'Categoría de Protección de rodamientos',
            'cartridgemechanicalseals': 'Categoría de cierres mecánicos',
            'gasseals': 'Categoría de cierres de gas',
            'componentseals': 'Categoría de cierres de componentes',
        }
    } else if (filterLang == "fr") {
        typeMapping = {
            '3dmodels': 'Modèles 3D',
        ...
        vidMapping = {
            'resourcescontenttypes': 'Index du contenu',
            'producttypes': 'Types de produits',
            'pillars': 'Index du contenu',
            'continents': 'Continents',
            'asia': 'Index des lieux',
            'europe': 'Index des lieux',
            'northamerica': 'Index des lieux',
            'southamerica': 'Index des lieux',
            'africa': 'Index des lieux',
            'australasia': 'Index des lieux',
            'middleeast': 'Index des lieux',
            'industry': 'Industrie',
            'glandpacking': 'Catégorie de tresses d’étanchéité',
            'sealsupportsystems': 'Catégorie de systèmes d’exploitation',
            'bearingprotectioncategories': 'Catégorie de protections de paliers',
            'cartridgemechanicalseals': 'Catégorie de garnitures mécaniques',
            'gasseals': 'Catégorie de garnitures gaz',
            'componentseals': 'Catégorie de garnitures mécaniques bi-composants',
        }
    } else if (filterLang == "de") {
        typeMapping = {
            '3dmodels': '3D-Modelle',
        ...
        vidMapping = {
            'resourcescontenttypes': 'Inhaltsverzeichnis',
            'producttypes': 'Produkttypen',
            'pillars': 'Inhaltsverzeichnis',
            'continents': 'Kontinente',
            'asia': 'Standorte Index',
            'europe': 'Standorte Index',
            'northamerica': 'Standorte Index',
            'southamerica': 'Standorte Index',
            'africa': 'Standorte Index',
            'australasia': 'Standorte Index',
            'middleeast': 'Standorte Index',
            'industry': 'Branchen',
            'glandpacking': 'Packungen Kategorie',
            'sealsupportsystems': 'Versorgungssysteme Kategorie',
            'bearingprotectioncategories': 'Lagerschutzdichtungen Kategorie',
            'cartridgemechanicalseals': 'Gleitringdichtungen Kategorie',
            'gasseals': 'Gasgeschmierte Dichtungen Kategorie',
            'componentseals': 'Komponentendichtungen Kategorie',
        }
    } else if (filterLang == "it") {
        typeMapping = {
            '3dmodels': 'Modelli 3D',
        ...
        vidMapping = {
            'resourcescontenttypes': 'Indice dei contenuti',
            'producttypes': 'Tipi di prodotti',
            'pillars': 'Indice dei contenuti',
            'continents': 'Continenti',
            'asia': 'Indice delle località',
            'europe': 'Indice delle località',
            'northamerica': 'Indice delle località',
            'southamerica': 'Indice delle località',
            'africa': 'Indice delle località',
            'australasia': 'Indice delle località',
            'middleeast': 'Indice delle località',
            'industry': 'Industria',
            'glandpacking': 'Product category Baderne',
            'sealsupportsystems': 'Categoria di Sistemi di Supporto per le tenute',
            'bearingprotectioncategories': 'Categoria di Protettori per cuscinetti',
            'cartridgemechanicalseals': 'Categoria di Tenute Meccaniche',
            'gasseals': 'Categoria di Tenute a gas',
            'componentseals': 'Categoria di Tenute a componenti',
        }
    }
    else if (filterLang == "pl") {
        typeMapping = {
        ...
        vidMapping = {
            'resourcescontenttypes': 'Indeks treści',
            'producttypes': 'Rodzaje produktów',
            'pillars': 'Indeks treści',
            'continents': 'Kontynenty',
            'asia': 'Indeks lokalizacji',
            'europe': 'Indeks lokalizacji',
            'northamerica': 'Indeks lokalizacji',
            'southamerica': 'Indeks lokalizacji',
            'africa': 'Indeks lokalizacji',
            'australasia': 'Indeks lokalizacji',
            'middleeast': 'Indeks lokalizacji',
            'industry': 'Przemysł',
            'glandpacking': 'Pakowanie dławika Kategorię',
            'sealsupportsystems': 'Systemy wsparcia uszczelnień Kategorię',
            'bearingprotectioncategories': 'Ochrona łożyska Kategorię',
            'cartridgemechanicalseals': 'Uszczelnienia mechaniczne kartridża Kategorię',
            'gasseals': 'Uszczelnienia gazowe Kategorię',
            'componentseals': 'Uszczelnienia modułowe Kategorię',
        }
    }
    else if (filterLang == "tr") {
        typeMapping = {
        ...
        vidMapping = {
            'resourcescontenttypes': 'İçerik Dizini',
            'producttypes': 'Ürün Türleri',
            'pillars': 'İçerik Dizini',
            'continents': 'Kıtalar',
            'asia': 'Konumlar Dizini',
            'europe': 'Konumlar Dizini',
            'northamerica': 'Konumlar Dizini',
            'southamerica': 'Konumlar Dizini',
            'africa': 'Konumlar Dizini',
            'australasia': 'Konumlar Dizini',
            'middleeast': 'Konumlar Dizini',
            'industry': 'Sanayi',
            'glandpacking': 'Yumuşak Salmastralar Kategorisi',
            'sealsupportsystems': 'Salmastra Destek Sistemleri Kategorisi',
            'bearingprotectioncategories': 'Rulman Koruyucu Kategorisi',
            'cartridgemechanicalseals': 'Mekanik Salmastralar Kategorisi',
            'gasseals': 'Gaz Salmastraları Kategorisi',
            'componentseals': 'Komponent Salmastralar Kategorisi',
        }
    }
    else if (filterLang == "zh-hans") {
        typeMapping = {
        ...
        vidMapping = {
            ...
            'industry': '行业',
            'glandpacking': '密封填料类别',
            'sealsupportsystems': '密封支撑系统类别',
            'bearingprotectioncategories': '轴承保护类别',
            'cartridgemechanicalseals': '墨盒机械密封件类别',
            'gasseals': '气体密封件类别',
            'componentseals': '组件密封件类别',
        }
    } else if (filterLang =="ar") {
        typeMapping = {
            '3dmodels': 'نماذج 3D',
                    ...
                    item(data, { html, components }){
                        if(filterLang == 'en'){
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <small class="${data.type == "Statements and Compliance" ? '' : 'd-none'}">/en/resources/statements-and-compliance/</small>
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <a class="${data.type == "Statements and Compliance" ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="/en/resources/statements-and-compliance/">Read More</a>
                                    </div>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? 'Seguir leyendo' : 'Ver vídeo'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? 'En savoir plus' : 'Regarder la vidéo'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? 'Mehr lesen' : 'Video ansehen'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? 'Per saperne di più' : 'Guarda il video'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? 'Czytaj więcej' : 'Obejrzyj film'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? 'Daha Fazla Oku' : 'Videoyu izle'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p class=${data.field_summary ? '' : 'd-none'}>${data.field_summary}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" href="${data.field_link_to_content}">${data.field_post_type != "youtube" ? '更多信息' : '观看视频'}</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">Read More</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">Seguir leyendo</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">En savoir plus</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">Mehr lesen</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">Per saperne di più</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">Daha Fazla Oku</a>
                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-8 d-flex flex-column">
                                        ...
                                        <p id="contentCat" class="lead ${data.type ? '' : 'd-none'}">${data.type}</p>
                                        <p class=${data.summary ? '' : 'd-none'}>${data.summary}</p>
                                        <a class="${data.field_link_to_content ? '' : 'd-none'} btn btn-primary view-details align-self-end" rel="nofollow" href="${data.field_link_to_content}">更多信息</a>
