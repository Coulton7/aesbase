                            ...
                            return html `<div class="search-result" data-insights-object-id="${data.objectID}" data-insights-position="${data.__position}" data-insights-query-id="${data.__queryID}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-4">
                                        ...
                                        <img class="${data.bearing_product_image_uri ? '' : 'd-none'} img-fluid ratio ratio-1x1 overflow-hidden" src="${data.bearing_product_image_uri[0]}" height="420" width="420" alt="${data.title}" />
                                    </div>
                                </div>
                            </div>`
                        } else if(filterLang == ''){
