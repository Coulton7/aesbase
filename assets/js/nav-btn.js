document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelector("#overlay-search").addEventListener("click", function searchBtn() {
    document.getElementById("overlay-search").classList.toggle("change");
      if (y.style.height === "100%") {
        ...
        if (x.style.height == "100%") {
          ...
          document.querySelector("#overlay-search").classList.remove("change");
          document
            .querySelector("#overlay-search")
            .classList.add("overlay-btn");
        } else if (s.style.height == "100%") {
          s.style.height = "1px";
          s.style.bottom = "-1px";
          document.querySelector("#overlay-share").classList.remove("change");
  ...
  document.querySelector("#overlay-share").addEventListener("click", function shareBtn() {
    ...
    document.getElementById("mob-overlay-search").classList.toggle("change");
      if (y.style.height === "100%") {
        ...
        if (x.style.height == "100%") {
          ...
          x.style.bottom = "-1px";
          document
            .querySelector("#mob-overlay-search")
  ...
  if (tabletOverlayBtn != null) {
    document
      .querySelector("#tablet-overlay-btn")
      .addEventListener("click", function navBtn() {
        document
          .getElementById("tablet-overlay-btn")
        ...
        if (x.style.height === "100%") {
          ...
          document.querySelector("#overlay-btn").classList.add("overlay-btn");
          document
            .querySelector(".navigation_col")
            .classList.remove("overlay-menu");
        } else {
          x.style.height = "100%";
          document.querySelector("body").classList.add("noscroll");
          document
            .querySelector("#overlay-btn")
            .classList.remove("overlay-btn");
          document
            .querySelector(".navigation_col")
            .classList.add("overlay-menu");
        }
      });
  } else {
    return false;
